# Project Wiki: James Nerf Squad

This is the project wiki for James Nerf Squad. It holds knowledge specific to this project. Knowledge shared across every project lives in the global wiki at the team root.
...
Architecture Decision Records are in `decisions/`. Nine ADRs were recorded during the initial backfill review by Jacob (2026-05-23).

## Patterns

No project-specific pattern pages yet. See global wiki `docs/patterns/` for the canvas-game and input-state-machine patterns.
